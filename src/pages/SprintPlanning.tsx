...
const mockSprints: Sprint[] = [
  {
    id: "sprint-1",
    name: "Sprint 23 - Authentication & Security",
    goal: "Implement secure user authentication and improve data protection",
    status: "active",
  ...
  {
    id: "sprint-2",
    name: "Sprint 22 - Dashboard Improvements", 
    goal: "Enhance user dashboard with better analytics and mobile support",
    status: "completed",
