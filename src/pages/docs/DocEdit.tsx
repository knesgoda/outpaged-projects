...
export default function DocEdit() {
  ...
  if (!doc || !docIdParam) {
    return (
      <section className="p-6 space-y-4">
        ...
        <Button variant="link" onClick={() => navigate("/docs")}>Back to docs</Button>
      </section>
    );
  }
  ...
  const handleCancel = () => {
    ...
    setHasSaved(true);
    navigate(docIdParam ? `/docs/${docIdParam}` : "/docs");
  };
  ...
  return (
    <section className="mx-auto max-w-3xl space-y-6 p-6">
      ...
      <header className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">Update the content and publish state.</p>
      </header>
