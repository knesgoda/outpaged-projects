...
create policy "project_files_rw_members" on public.project_files
...
create policy "files_select_members" on storage.objects
...
create policy "files_insert_members" on storage.objects
for insert to authenticated
with check (bucket_id = 'files');

create policy "files_update_members" on storage.objects
for update to authenticated
using (bucket_id = 'files');

create policy "files_delete_members" on storage.objects
